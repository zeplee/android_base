...
//        super.onCreate();
//        UMConfigure.init(this, "5aefda2cf29d984dd50000b7", "aacsUmeng", UMConfigure.DEVICE_TYPE_PHONE,
...
//                SharedPreferences settings = context.getSharedPreferences("aac", Context.MODE_PRIVATE);
...
//                    Intent launchIntent = context.getPackageManager().getLaunchIntentForPackage("aac");
